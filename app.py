# -*- coding: utf-8 -*-
"""
Created on Thu Aug 29 17:18:37 2024
...
if uploaded_file is not None:
    ...
    seasonal_periods = st.sidebar.number_input("Períodos estacionales (por ejemplo, 5 para datos diarios)", min_value=1, value=5)
    ...
    # Pronóstico
    forecast_periods = 252  # Para días hábiles en un año
    forecast = model.forecast(forecast_periods)

    # Crear un índice de fechas para el pronóstico (días hábiles del año 2024)
    forecast_index = pd.bdate_range(start='2024-01-01', periods=forecast_periods)  # Cambia 'M' a 'D' para datos diarios
    ...
    # Limitar el eje x para mostrar todo 2024
...
4. **Configuración de parámetros**: Ajuste los parámetros del modelo Holt-Winters:
   - **Períodos estacionales**: Especifique el número de períodos que representan un ciclo completo (por ejemplo, 5 para datos diarios).
...
5. **Pronóstico**: El pronóstico se realiza para todos los días hábiles del año 2024.
